...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		// The next line zooms in and centers the map at 
	    // 17.7 (latitude) and 83.1 (longitude)
		map2 = new UnfoldingMap(this, 400, 50, 350, 500, provider);
		map2.zoomAndPanTo(zoomLevel, new Location(17.7f, 83.1f));
		// This line makes the map2 interactive, meaning I can zoom in, drag my map etc
